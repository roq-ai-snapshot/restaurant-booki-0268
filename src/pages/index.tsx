  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to Restaurant Booking Engine, your ultimate solution for seamless table reservations and efficient restaurant management. Experience the ease of dining like never before."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Restaurant Booking Engine, your ultimate solution for seamless table reservations and efficient restaurant management. Experience the ease of dining like never before.`}
            </Text>
            <Box
